...
⚠️ Many containers don’t include ping — this is normal.
...
🔥 VERY IMPORTANT K8S DIFFERENCES (Exam Gold)
Old VM Way	Kubernetes Way
systemctl	Pod status
netstat on server	netstat inside pod
ping IP	service name
DB IP	MySQL service
process crash	pod restart
